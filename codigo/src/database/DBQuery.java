...
public class DBQuery {
	...
	public int deleteById(int id) {
		...
		String sql = "DELETE FROM "+this.tableName+" WHERE "+this.fieldKey+" = " + id;
	...
	public int updateToken(String email, String token) {
		...
		String sql = "\nUPDATE "+this.tableName+" SET token = '" + token + "'";
	...
	public int updateSenha(int idUsuario, String senha) {
		
		String sql = "\nUPDATE "+this.tableName+" SET senha = '" + senha + "'";
